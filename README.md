...
<head>
<meta charset="UTF-8">
<title>Green Garden Landscaping Portal</title>
<style>
  body {
  ...
  .tool:nth-child(1) img { animation-delay: 0s; }
  .tool:nth-child(2) img { animation-delay: 0.1s; }
  .tool:nth-child(3) img { animation-delay: 0.2s; }
  .tool:nth-child(4) img { animation-delay: 0.3s; }
  .tool:nth-child(5) img { animation-delay: 0.4s; }
...
<header>
  <img src="https://i.imgur.com/gFFL080.png" alt="Green Garden Landscaping Logo" class="company-logo">
  <div id="tools">
    <div class="tool">
